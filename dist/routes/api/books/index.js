...
function bookRoutes(fastify, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        fastify.get(`/${apiPath}`, (request, reply) => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield book_service_1.default.list({
                limit,
                offset,
                orderBy,
                orderDirection
        ...
        fastify.delete(`/${apiPath}/:id`, (request, reply) => __awaiter(this, void 0, void 0, function* () {
            const { id } = request.params;
            return book_service_1.default.deleteById(id);
        }));
    });
}
